...
# The main function returns the extrapolated results in a DataFrame
output = extrapolate_with_sw(rates_obs, ufr, t2, Tau, extrapolation_target, nrofcoup, instrument, alfamin)
